...
from mtn_sms_v3 import MtnSMSV3, AsyncMtnSMSV3, APIResponseValidationError
from mtn_sms_v3._types import Omit
from mtn_sms_v3._models import BaseModel, FinalRequestOptions
from mtn_sms_v3._constants import RAW_RESPONSE_HEADER
from mtn_sms_v3._exceptions import APIStatusError, APITimeoutError, APIResponseValidationError
from mtn_sms_v3._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: MtnSMSV3 | AsyncMtnSMSV3) -> int:
...
class TestMtnSmsv3:
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "mtn_sms_v3/_legacy_response.py",
                        "mtn_sms_v3/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "mtn_sms_v3/_compat.py",
    ...
    def test_multipart_repeating_array(self, client: MtnSMSV3) -> None:
        request = client._build_request(
    ...
    def test_base_url_env(self) -> None:
        with update_env(MTN_SMS_V3_BASE_URL="http://localhost:5000/from/env"):
            client = MtnSMSV3(client_id=client_id, client_secret=client_secret, _strict_response_validation=True)
    ...
    def test_base_url_trailing_slash(self, client: MtnSMSV3) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: MtnSMSV3) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: MtnSMSV3) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    @mock.patch("mtn_sms_v3._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.post("/messages/sms/outbound").mock(side_effect=httpx.TimeoutException("Test timeout error"))
    ...
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.post("/messages/sms/outbound").mock(return_value=httpx.Response(500))
    ...
    def test_retries_taken(
        ...
        respx_mock.post("/messages/sms/outbound").mock(side_effect=retry_handler)
    ...
    def test_omit_retry_count_header(
        self, client: MtnSMSV3, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
...
class TestAsyncMtnSmsv3:
    ...
    def test_multipart_repeating_array(self, async_client: AsyncMtnSMSV3) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(MTN_SMS_V3_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncMtnSMSV3(client_id=client_id, client_secret=client_secret, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncMtnSMSV3) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncMtnSMSV3) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncMtnSMSV3) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_retries_taken(
        ...
        response = await client.messages.sms.with_raw_response.outbound(
            client_correlator_id="clientCorrelatorId",
            message="message",
            receiver_address=["23423456789", "23423456790"],
            service_code="11221 or 131",
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncMtnSMSV3, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
    ...
    def test_get_platform(self) -> None:
        ...
        from mtn_sms_v3._utils import asyncify
        from mtn_sms_v3._base_client import get_platform 
