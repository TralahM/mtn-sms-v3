...
from ._exceptions import MtnSMSV3Error, APIStatusError
...
class MtnSMSV3(SyncAPIClient):
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous mtn-sms-v3 client instance.
        ...
        if base_url is None:
            base_url = os.environ.get("MTN_SMS_V3_BASE_URL")
        if base_url is None:
            base_url = f"https://api.mtn.com/v3/sms/"
...
class AsyncMtnSMSV3(AsyncAPIClient):
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async mtn-sms-v3 client instance.
